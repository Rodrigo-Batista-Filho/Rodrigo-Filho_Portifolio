    ...
    return (
        <section className="c-space my-20">
            <div className="w-full text-white-600">
                <h3 className="head-text">My Tech Experience</h3>

                <div className="work-container">
                    <div className="work-canvas">
                        <Canvas>
                            {/* Ambient light and spotlight with default values */}
                            ...
                            <OrbitControls
                                ...
                                minPolarAngle={Math.PI / 4} // Angle constraints
                            />
                    ...
                    <div className="work-content">
                        <div className="sm:py-10 py-5 sm:px-5 px-2.5">
                            {workExperiences.map(({ id, name, title, icon , animation}) => (
